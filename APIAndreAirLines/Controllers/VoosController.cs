...
namespace APIAndreAirLines.Controllers
{
    ...
    public class VoosController : ControllerBase
    {
        ...
        public VoosController(APIAndreAirLinesContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.Voo.Include(e => e.Destino.Endereco)
                                     .Include(e => e.Origem.Endereco)
                                     .Include(e => e.Aeronave).ToListAsync();
        }
        ...
        {
            var voo = await _context.Voo.Include(e => e.Destino.Endereco)
                                        .Include(e => e.Origem.Endereco)
        ...
        {
            var aeronave = await _context.Aeronave.FindAsync(voo.Aeronave.Codigo);
            if (aeronave != null)
